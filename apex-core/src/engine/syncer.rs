...
impl OrderBookSyncer for EmptyOrderBookSyncer {
    fn add_order(&self, _id: u128, _order: &Order) {}

    fn update_order(&self, _id: u128, _order: &Order) {}

    fn cancel_order(&self, _id: u128, _order: &Order) {}

    fn matched(&self, _id: u128, _updated: &Vec<Order>, _trades: &Vec<Trade>) {}
}
